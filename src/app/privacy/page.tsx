...
const Privacy = () => {
  return (
    <div className="prose mx-auto my-16">
      <h1>Privacy Policy for compress.cat</h1>

      <p>
        At Compress Cat, accessible from https://compress.cat/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Compress
        Cat and how we use it.
      </p>
      ...
      <p>
        compress.cat legal basis for collecting and using the personal
      ...
      <ul>
        <li>compress.cat needs to perform a contract with you</li>
        <li>You have given compress.cat permission to do so</li>
        <li>
          Processing your personal information is in compress.cat legitimate
          interests
        </li>
        <li>compress.cat needs to comply with the law</li>
      </ul>

      <p>
        compress.cat will retain your personal information only for as long as
      ...
      <p>
        Compress Cat follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Compress Cat uses &quot;cookies&quot;. These
      ...
      <p>
        ...
        advertising partners of Compress Cat.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Compress Cat, which are sent
      ...
      <p>
        Note that Compress Cat has no access to or control over these cookies
      ...
      <p>
        Compress Cat&apos;s Privacy Policy does not apply to other advertisers
      ...
      <p>
        Compress Cat does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Compress Cat. This policy is not applicable to
