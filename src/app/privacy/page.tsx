...
const Privacy = () => {
  return (
    <div className="prose mx-auto my-16">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Compress Cat.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Compress Cat, accessible from{' '}
            <a
              href="https://compress.cat/"
      ...
      <ul>
        <li>By email: support@compress.cat</li>
      </ul>
    </div>
  );
};
